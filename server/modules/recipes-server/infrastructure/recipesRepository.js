  ...
  return {
    ...
    async create(recipe) {
      const result = await pg.query(
        'INSERT INTO recipes (id, name, "timesPerDay", duration, editable) VALUES ($1, $2, $3, $4, $5) RETURNING *',
        [recipe.id, recipe.name, recipe.timesPerDay, recipe.duration, recipe.editable],
      );
      return result.rows[0];
    },
