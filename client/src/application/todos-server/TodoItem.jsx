...
import {
  ...
  selectIsLastTodo,
  selectIsFirstTodo,
} from "@/application/todos-server/todos.selectors.js";
import { todosActions } from "@/application/todos-server/todos.actions.js";
...
const mapDispatchToProps = (dispatch, ownProps) => {
  ...
  return {
    onDelete: () => dispatch(todosActions.deleteTodoAPI(id)),
    onMoveUp: () => dispatch(todosActions.moveTodoUpAPI(id)),
    onMoveDown: () => dispatch(todosActions.moveTodoDownAPI(id)),
  };
}
